"""
Django settings for favorites service.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-favorites-service-dev-key-change-in-production')
...
MIDDLEWARE = [
    ...
    'favorites.middleware.AuthMiddleware',
]
